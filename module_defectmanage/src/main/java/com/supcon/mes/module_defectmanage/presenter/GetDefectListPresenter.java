...
public class GetDefectListPresenter extends GetDefectListContract.Presenter {
    ...
    public void getDefectList(String tableNo, String areaCode, int pageNo) {
        ...
        mCompositeSubscription.add(DefectManagerHttpClient.getDefectList(entity)
                .onErrorReturn(new FunctionEx<Throwable, BapPageResultEntity<DefectOnlineEntity>>() {
                    @Override
                    public BAP5CommonEntity apply(Throwable throwable)  {
                        return super.apply(throwable);
                    }
                }).subscribe(new Consumer<BAP5CommonEntity<BapPageResultEntity<DefectOnlineEntity>>>() {
                    @Override
                    public void accept(BAP5CommonEntity<BapPageResultEntity<DefectOnlineEntity>> incidentTmpEntityCommonEntity) throws Exception {
