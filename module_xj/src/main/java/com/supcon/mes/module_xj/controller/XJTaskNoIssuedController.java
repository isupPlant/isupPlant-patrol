...
public class XJTaskNoIssuedController extends BaseDataController implements XJTaskContract.View {
...
//    private List<XJTaskEntity> mNoIssuedTasks = new ArrayList<>();
    ...
    public XJTaskNoIssuedController(Context context) {
        super(context);
    }
...
//            mNoIssuedTasks.addAll(taskEntities);
        }
